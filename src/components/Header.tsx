    ...
    <header className="sticky top-0 z-40 border-b bg-[color:var(--bg-elevated)]/95 backdrop-blur-xl" style={{ borderColor: "var(--border)" }}>
      <div className="mx-auto flex max-w-7xl items-center gap-3 px-4 py-3 sm:gap-5 sm:px-6">
        ...
        <nav aria-label="Navigation principale" className="ml-auto hidden items-center rounded-xl bg-[color:var(--bg-soft)] p-1 text-sm sm:flex">
          <Link href="/bibliotheque" className="focus-ring rounded-lg px-4 py-2 font-semibold hover:bg-[color:var(--bg-elevated)]">Accueil</Link>
          <Link href="/catalogue" className="focus-ring rounded-lg px-4 py-2 font-semibold hover:bg-[color:var(--bg-elevated)]">Catalogue</Link>
          <Link href="/mes-prompts" className="focus-ring rounded-lg px-4 py-2 font-semibold hover:bg-[color:var(--bg-elevated)]">Mes créations</Link>
          <Link href="/dossiers" className="focus-ring rounded-lg px-4 py-2 font-semibold hover:bg-[color:var(--bg-elevated)]">Dossiers</Link>
